...
from apps.utils.poll_storage import get_non_voters_for_day, load_votes, update_non_voters
    ...
    try:
        ...
        if all_voted:
            ...
            if not celebration_id:
                ...
                embed.set_image(url="https://media1.tenor.com/m/7aYj9m-zlLcAAAAC/super-mario-ending-screen.gif")

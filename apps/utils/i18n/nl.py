...
STATUS = {
    ...
    "period_header": "📅 Periode: {period}",
    "period_enabled": "Ingeschakeld",
    "period_disabled": "Uitgeschakeld",
    "period_open": "🟢 Open",
    "period_closed": "🔴 Gesloten",
    "period_opens": "Opent: {day} {time}",
    "period_closes": "Sluit: {day} {time}",

...
class TestResetEnArchiefUitgebreid(BaseTestCase):
    ...
    async def test_week_dates_eu_returns_upcoming_weekend(self):
        """Test dat _week_dates_eu het VERLEDEN weekend retourneert, niet toekomstige."""
        ...
        # Verwacht afgelopen weekend: vrijdag 31 okt, zaterdag 1 nov, zondag 2 nov
        self.assertEqual(vr, "2025-10-31")
        self.assertEqual(za, "2025-11-01")
        self.assertEqual(zo, "2025-11-02")
        self.assertEqual(week, "2025-W44")  # Week 44

    async def test_week_dates_eu_on_friday_returns_same_friday(self):
        """Test dat _week_dates_eu op vrijdag het VORIGE weekend retourneert."""
        # Vrijdag 7 november 2025
        friday = datetime(2025, 11, 7, 10, 0, 0, tzinfo=ZoneInfo("Europe/Amsterdam"))
        _, vr, za, zo = ar._week_dates_eu(friday)

        # Verwacht: VORIG weekend (vrijdag 31 okt, zaterdag 1 nov, zondag 2 nov)
        # Want de logica geeft altijd het AFGERONDE weekend dat VOOR nu plaatsvond
        self.assertEqual(vr, "2025-10-31")
        self.assertEqual(za, "2025-11-01")
        self.assertEqual(zo, "2025-11-02")

    async def test_week_dates_eu_on_monday_returns_next_friday(self):
        """Test dat _week_dates_eu op maandag het AFGELOPEN weekend retourneert."""
        ...
        # Verwacht: afgelopen weekend (vrijdag 7, zaterdag 8, zondag 9 november)
        self.assertEqual(vr, "2025-11-07")
        self.assertEqual(za, "2025-11-08")
        self.assertEqual(zo, "2025-11-09")
        self.assertEqual(week, "2025-W45")
